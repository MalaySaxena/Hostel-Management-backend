...
# read data
data = pd.read_excel('room_list.xls')
...
# rename columns
data = data.rename(columns={'Room No': 'hostel_name',
...
# export
data.to_excel('final_room_list.xlsx', index=False)

# Open the workbook and define the worksheet
book = xlrd.open_workbook("final_room_list.xlsx")
...
for r in range(1, sheet.nrows):
    ...
    hostel_no_of_room = sheet.cell(r,3).value
    hostel_no_of_room_available= sheet.cell(r,4).value
    hostel_warden = sheet.cell(r,5).value
